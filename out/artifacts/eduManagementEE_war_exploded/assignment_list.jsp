                    ...
                    <div class="table-responsive">
                        ...
                        <table id="table" class="table table-striped data-table" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td>${as.assignmentDetails}</td>
                                <td>${as.assignmentSubject}</td>
                                <td>${as.publishedDate}</td>
                                <td>${as.submitDate}</td>
                                <td style="text-align: center"><a class="btn btn-primary" href="DownloadAssignmentServlet?assignmentId=${as.assignmentId}">Download</a></td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>
