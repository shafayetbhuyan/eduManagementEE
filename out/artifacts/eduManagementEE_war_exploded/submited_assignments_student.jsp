        ...
        <div class="col-md-12 mb-3">
            <div class="card">
                <div class="card-header">
                    <span><i class="bi bi-table me-2"></i></span><%= user.getFullName() %> || Submited Assignment List.
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <%
                            ArrayList<SubmitedAssignment> subAsByUserId = (ArrayList<SubmitedAssignment>) request.getAttribute("subAsByUserId");
                        %>
...
<script>
    ...
    $(document).ready(function () {
        $("#view-sub-assignments").addClass("active");
    });
